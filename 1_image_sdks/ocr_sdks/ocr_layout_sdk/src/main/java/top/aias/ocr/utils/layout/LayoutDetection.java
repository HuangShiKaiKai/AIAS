    ...
    public Criteria<Image, DetectedObjects> cnCriteria() {
        Criteria<Image, DetectedObjects> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("1_image_sdks/ocr_sdks/ocr_layout_sdk/models/picodet_lcnet_x1_0_fgd_layout_cdla_infer_onnx.zip"))
    ...
    public Criteria<Image, DetectedObjects> enCriteria() {
        ...
        Criteria<Image, DetectedObjects> criteria =
                Criteria.builder()
                        ...
                        .optModelName("inference")
                        .setTypes(Image.class, DetectedObjects.class)
                        .optModelPath(Paths.get("1_image_sdks/ocr_sdks/ocr_layout_sdk/models/picodet_lcnet_x1_0_fgd_layout_infer_onnx.zip"))
                        .optTranslator(new LayoutDetectionTranslator())
                        .optProgress(new ProgressBar())
                        .build();
    ...
    public Criteria<Image, DetectedObjects> tableCriteria() {
        ...
        Criteria<Image, DetectedObjects> criteria =
                Criteria.builder()
                        ...
                        .optModelName("inference")
                        .setTypes(Image.class, DetectedObjects.class)
                        .optModelPath(Paths.get("1_image_sdks/ocr_sdks/ocr_layout_sdk/models/picodet_lcnet_x1_0_fgd_layout_table_infer_onnx.zip"))
                        .optTranslator(new LayoutDetectionTranslator())
                        .optProgress(new ProgressBar())
                        .build();
