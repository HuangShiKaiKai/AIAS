...
//                        .optModelName("inference")
                        ...
                        .optModelPath(Paths.get("1_image_sdks/ocr_sdks/ocr_direction_det_sdk/models/ch_PP-OCRv2_det_infer.onnx"))
                        .optDevice(device)
    ...
    private Criteria<Image, DirectionInfo> clsCriteria() {
        ...
        Criteria<Image, DirectionInfo> criteria =
                Criteria.builder()
                        ...
                        .optModelPath(Paths.get("1_image_sdks/ocr_sdks/ocr_direction_det_sdk/models/ch_ppocr_mobile_v2.0_cls.onnx"))
                        .optDevice(device)
